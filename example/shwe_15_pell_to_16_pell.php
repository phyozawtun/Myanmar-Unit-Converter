...
if(isset($_POST['kyat'])){
	...
	$kyat = shwe_15_pell_to_16_pell($kyat);
  ...
  <body>
    ...
    <div class="container py-3">
      ...
      <main>
        ...
        <!-- Form Start -->
        <form action="./shwe_15_pell_to_16_pell.php#converter" id="converter" method="POST" class="row mb-5 pt-5">
          <div class="col-md-8 mx-auto">
            <h1 class="h2">Shwe 15 Pell to 16 Pell</h1>
            <div class="card">
