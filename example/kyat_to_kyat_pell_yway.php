  ...
  <body>
    ...
    <div class="container py-3">
      ...
      <main>
        ...
        <!-- Form Start -->
        <form action="kyat_to_kyat_pell_yway.php#converter" method="POST" class="row mb-5 pt-5">
          <div class="col-md-8 mx-auto">
            <h1 class="h2">Kyat to Kyat Pell Yway</h1>
            <div class="card">
              <div class="card-body py-4">

                  <div class="mb-3">
                    <label class="form-label">Input Kyat:</label>
                    <div class="input-group input-group-lg">
                      <input class="form-control" name="kyat" value="<?=isset($_POST['kyat'])?$_POST['kyat']:'';?>">
                    </div>
                  </div>
